...
class ExampleAlarmEditScreen extends StatefulWidget {
  ...
  ExampleAlarmEditScreen({Key? key, this.alarmSettings}) //const 삭제 
      : super(key: key);
...
class _ExampleAlarmEditScreenState extends State<ExampleAlarmEditScreen> {
  ...
  AlarmSettings buildAlarmSettings() {
    ...
    final alarmSettings = AlarmSettings(
      ...
      loopAudio: loopAudio,
      vibrate: vibrate,
      notificationTitle: showNotification ? 'WeatherToWeather' : null,
      notificationBody: showNotification ? '알람이 울립니다 ...' : null,
